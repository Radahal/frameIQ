...
public class MovieMetadataData extends IData {
    private final Long exifMetadataId;
    private final String metadata;

    public MovieMetadataData(Long id, Long creationUsId, Long modificationUsId, Date creationTime, Date modificationTime,
                             Long exifMetadataId,
                             String metadata) {
    ...
    public static final class Builder extends IDataBuilder {
        ...
        public MovieMetadataData build() {
            return new MovieMetadataData(id, creationUsId, modificationUsId, creationTime, modificationTime, exifMetadataId, metadata);
        }
