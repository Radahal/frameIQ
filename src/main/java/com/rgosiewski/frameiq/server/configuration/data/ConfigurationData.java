...
public class ConfigurationData extends IData {
    ...
    public static final class Builder extends IDataBuilder {
        ...
        public ConfigurationData build() {
            return new ConfigurationData(id, creationUsId, modificationUsId, creationTime, modificationTime, projectId, name, description, tag, inputFilename, algorithm, algorithmProperties, strategy);
        }
    }
}
